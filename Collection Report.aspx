<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Collection Report.aspx.cs" Inherits="Collection_Report" %>
    ...
    <table class="style1">
        <tr>
            <td style="border: thin inset #3399FF">
                <asp:Image ID="Image2" runat="server" Height="130px" 
                    ImageUrl="~/Images/banner.png" Width="1562px" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="border: thin inset #3399FF; text-align: center;" class="style3">
                <strong>COLLECTION REPORT</strong></td>
        </tr>
        <tr>
