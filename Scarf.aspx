<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Scarf.aspx.cs" Inherits="Scarf" %>
            ...
            <td style="border: thin inset #3399FF" class="style2">
                <table class="style1">
                    <tr>
                        <td class="style4">
                            <asp:Image ID="Image3" runat="server" Height="265px" 
                                ImageUrl="~/Images/Scarf/Beige Viscose Printed Scarf SC4.jpg" Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image4" runat="server" Height="265px" 
                                ImageUrl="~/Images/Scarf/Black Viscose Printed Scarf SC12.jpg" Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image5" runat="server" Height="265px" 
                                ImageUrl="~/Images/Scarf/Blue Viscose Printed Scarf SC1.jpg" Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image6" runat="server" Height="265px" 
                                ImageUrl="~/Images/Scarf/Blue Viscose Printed Scarf SC13.jpg" Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image7" runat="server" Height="265px" 
                                ImageUrl="~/Images/Scarf/Blue Viscose Printed Scarf SC2.jpg" Width="208px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style5">
                            Beige Viscose Printed Scarf SC4</td>
                        <td class="style5">
                            Black Viscose Printed Scarf SC12</td>
                        <td class="style5">
                            Blue Viscose Soft Scarf SC1</td>
                        <td class="style5">
                            Blue Viscose Printed Scarf SC13</td>
                        <td class="style5">
                            Blue 
                            Star Designed Scarf SC2</td>
                    </tr>
                    <tr>
                        <td class="style5">
                            Product ID 11</td>
                    ...
                    <tr>
                        ...
                        <td class="style7">
                            <strong>₹380</strong></td>
                        <td class="style7">
                            <strong>₹400</strong></td>
                        <td class="style7">
                            <strong>₹425</strong></td>
                    </tr>
                    <tr>
                        <td class="style4">
