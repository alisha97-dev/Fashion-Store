<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Saree.aspx.cs" Inherits="Saree" %>
        ...
        <tr>
            <td style="border: thin inset #3399FF">
                <asp:Image ID="Image2" runat="server" Height="130px" 
                    ImageUrl="~/Images/banner.png" Width="1570px" />
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td class="style4">
                            <asp:Image ID="Image3" runat="server" Height="265px" 
                                ImageUrl="~/Images/Saree/Black Brasso Saree With Blouse IW6728.jpg" 
                                Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image4" runat="server" Height="265px" 
                                ImageUrl="~/Images/Saree/Black Silk Saree With Blouse SD23890.jpg" 
                                Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image5" runat="server" Height="265px" 
                                ImageUrl="~/Images/Saree/Grey Moss Chiffon Saree With Blouse IW16680.jpg" 
                                Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image6" runat="server" Height="265px" 
                                ImageUrl="~/Images/Saree/Grey Silk Saree With Blouse SD23759.jpg" 
                                Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image7" runat="server" Height="265px" 
                                ImageUrl="~/Images/Saree/Maroon Chiffon Saree With Blouse IW20546.jpg" 
                                Width="208px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style5">
                            Black Brasso Saree With Blouse<br />
&nbsp;IW6728</td>
                        <td class="style5">
                            Black Silk Saree With Blouse
                            <br />
                            SD23890</td>
                        <td class="style5">
                            Grey Moss Chiffon Saree With Blouse
                            <br />
                            IW16680</td>
                        <td class="style5">
                            Grey Silk Saree With Blouse
                            <br />
                            SD23759</td>
                        <td class="style5">
                            Maroon Chiffon Saree With Blouse
                            <br />
                            IW20546</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="style7">
                            <strong>₹2500</strong></td>
                        <td class="style7">
                            <strong>₹2800</strong></td>
                        <td class="style7">
                            <strong>₹2800</strong></td>
                        <td class="style7">
