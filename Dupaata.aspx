<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dupaata.aspx.cs" Inherits="Dupaata" %>
...
<body>
        ...
        <tr>
            <td style="border: thin inset #3399FF">
                <asp:Image ID="Image2" runat="server" Height="130px" 
                    ImageUrl="~/Images/banner.png" Width="1564px" />
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td class="style4">
                            <asp:Image ID="Image3" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Dark Green Viscose Dupatta DB2005.jpg" 
                                Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image4" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Green Organza Dupatta DB2064.jpg" Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image5" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Green Organza Dupatta DB2065.jpg" Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image6" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Multicolor Gaji Silk Dupatta DB2024.jpg" 
                                Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image7" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Multicolor Gaji Silk Dupatta DB2025.jpg" 
                                Width="208px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="style5">
                            Dark Green Viscose Dupatta DB2005</td>
                        <td class="style5">
                            Green Organza Dupatta DB2064</td>
                        <td class="style5">
                            Green Organza Dupatta DB2065</td>
                        <td class="style5">
                            Multicolor Gaji Silk Dupatta DB2024</td>
                        <td class="style5">
                            Multicolor Gaji Silk Dupatta DB2025</td>
                    </tr>
                    <tr>
                        <td class="style5">
                            Product ID 1</td>
    ...
    <table class="style1">
                    <tr>
                        <td class="style4">
                            <asp:Image ID="Image1" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Dark Green Viscose Dupatta DB2005.jpg" 
                                Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image8" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Green Organza Dupatta DB2064.jpg" Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image9" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Green Organza Dupatta DB2065.jpg" Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image10" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Multicolor Gaji Silk Dupatta DB2024.jpg" 
                                Width="208px" />
                        </td>
                        <td class="style4">
                            <asp:Image ID="Image11" runat="server" Height="265px" 
                                ImageUrl="~/Images/Dupatta/Multicolor Gaji Silk Dupatta DB2025.jpg" 
                                Width="208px" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="style4">
                            <asp:ImageButton ID="ImageButton6" runat="server" Height="33px" 
                                ImageUrl="~/Images/order-now-blue-3d.jpg" Width="139px" 
                                onclick="ImageButton1_Click" />
                        </td>
                        <td class="style4">
                        ...
                        <td class="style4">
                            <asp:ImageButton ID="ImageButton8" runat="server" Height="33px" 
                                ImageUrl="~/Images/order-now-blue-3d.jpg" Width="139px" 
                                onclick="ImageButton3_Click" />
                        </td>
                        <td class="style4">
                            <asp:ImageButton ID="ImageButton9" runat="server" Height="33px" 
                                ImageUrl="~/Images/order-now-blue-3d.jpg" Width="139px" 
                                onclick="ImageButton4_Click" />
                        </td>
                        <td class="style4">
                            <asp:ImageButton ID="ImageButton10" runat="server" Height="33px" 
                                ImageUrl="~/Images/order-now-blue-3d.jpg" Width="139px" 
                                onclick="ImageButton5_Click" />
                        </td>
                    </tr>
