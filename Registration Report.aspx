<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Registration Report.aspx.cs" Inherits="Registration_Report" %>
    ...
    <table class="style1">
        <tr>
            <td style="border: thin inset #3399FF">
                <asp:Image ID="Image2" runat="server" Height="130px" 
                    ImageUrl="~/Images/banner.png" Width="1702px" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="border: thin inset #3399FF; text-align: center;" class="style3">
                <strong>REGISTRATION REPORT</strong></td>
        </tr>
        <tr>
