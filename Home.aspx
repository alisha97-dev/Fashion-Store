...
<body>
    ...
    <table class="style1">
        <tr>
            <td style="border: thin inset #3399FF">
               <asp:Image ID="Image2" runat="server" Height="130px" 
                    ImageUrl="~/Images/banner.png" Width="1633px" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="border: thin inset #3399FF; text-align: center;" class="style2">
                <asp:Image ID="Image3" runat="server" Height="330px" 
                    ImageUrl="~/Images/Slide Show/Slide Show 1.gif" Width="810px" />
                </td>
        </tr>
    </table>
    </form>
